 ...
 * integers, NN (students in the class) and KK (the cancelation threshold). The
 * second line contains NN space-separated integers (a1,a2,…,aNa1,a2,…,aN)
 * describing the arrival times for each student.
 * 
 * Note: Non-positive arrival times (ai≤0ai≤0) indicate the student arrived
 * early or on time; positive arrival times (ai>0ai>0) indicate the student
 * arrived aiai minutes late.
 * 
 * Output Format
 * 
